package com.frank.simpleview.layout;
...
public class AutoLayout extends ViewGroup {
    ...
    public AutoLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.AutoLayoutDefault);
    }
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            grivate = typedArray.getInt(R.styleable.AutoLayout_grivate, grivate);
            horizontal_Space = typedArray.getDimension(R.styleable.AutoLayout_horizontal_Space, horizontal_Space);
            vertical_Space = typedArray.getDimension(R.styleable.AutoLayout_vertical_Space, vertical_Space);
            isFull = typedArray.getBoolean(R.styleable.AutoLayout_isFull, isFull);
        }
    }
